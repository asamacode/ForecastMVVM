...
import com.asama.luong.forecastmvvm.internal.NoConnectivityException
...
class WeatherNetworkDataSourceImpl(
    ...
    override suspend fun fetchFutureWeather(location: String, languageCode: String) {
        try {
            val fetchedFutureWeather = apiService.getFutureWeather(location, FORECAST_DAYS_COUNT, languageCode).await()
